                             ...
                             SPDesktop* desktop, unsigned int tag)
{
    std::visit(VariantVisitor{
        [item, tag](const PaintEditDelegate::CssOp& o) {
            set_item_style(item, o.css.get());
            item->requestModified(SP_OBJECT_MODIFIED_FLAG | tag);
        },
        [item, tag](const PaintEditDelegate::StrokeWidthOp& o) {
            set_stroke_width(item, o.width, o.hairline, o.unit);
            item->requestModified(SP_OBJECT_MODIFIED_FLAG | tag);
        },
        [item, tag](const PaintEditDelegate::DashOp& o) {
            double scale = item->i2doc_affine().descrim();
            if (Preferences::get()->getBool("/options/dash/scale", true)) {
        ...
        [item, tag](const PaintEditDelegate::OpacityOp& o) {
        ...
        [item](const PaintEditDelegate::BlendModeOp& o) {
            if (o.clear) ::clear_blend_mode(item);
            else ::set_blend_mode(item, o.mode);
        },
        [item](const PaintEditDelegate::VisibilityOp& o) {
            item->setExplicitlyHidden(o.hidden);
        },
        [item, desktop](const PaintEditDelegate::GradientOp& o) {
            sp_item_apply_gradient(item, o.vector, desktop, o.type, false,
                                   o.fill ? FILL : STROKE);
        },
        [item](const PaintEditDelegate::PatternOp& o) {
            sp_item_apply_pattern(item, o.pattern, o.fill ? FILL : STROKE,
                                  o.color, o.label, o.transform, o.offset,
                                  o.uniform_scale, o.gap);
        },
        [item](const PaintEditDelegate::HatchOp& o) {
            sp_item_apply_hatch(item, o.hatch, o.fill ? FILL : STROKE,
                                o.color, o.label, o.transform, o.offset,
                                o.pitch, o.rotation, o.thickness);
        },
        [item](const PaintEditDelegate::MeshOp& o) {
            sp_item_apply_mesh(item, o.mesh, item->document, o.fill ? FILL : STROKE);
        },
        [item, desktop, tag](const PaintEditDelegate::SwatchOp& o) {
            swatch_operation(item, o.vector, desktop, o.fill, o.op,
