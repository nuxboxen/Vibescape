...
void build_menu()
{
    ...
    // Set the shared recent files menu and list
    Inkscape::IO::recent_files_menu = builder->get_object<Gio::Menu>("recent-files");
    Inkscape::IO::recent_files_list = Inkscape::IO::get_recent_files_list();
    Inkscape::IO::build_recent_files_menu(Inkscape::IO::recent_files_menu, Inkscape::IO::recent_files_list);
