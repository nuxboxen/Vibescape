...
enum FilterPrimitiveType
{
    ...
    NR_FILTER_SPECTRAL_BILATERAL, // Inkscape extension — see doc/spectral/progress.md
    NR_FILTER_SPECTRAL_DISTANCE,  // Inkscape extension — see doc/spectral/progress.md
    NR_FILTER_SPECTRAL_NOISE,     // Inkscape extension — see doc/spectral/progress.md
    NR_FILTER_TILE,
