...
#ifndef SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_TILE_H
#define SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_TILE_H
...
#endif // SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_TILE_H
/*
  Local Variables:
  mode:c++
