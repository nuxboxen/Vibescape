 ...
 */
#ifndef SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_PRIMITIVE_H
#define SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_PRIMITIVE_H
...
public:
    ...
    virtual void update() {}
    virtual void render(Slot &slot) const;
    ...
    virtual bool uses_input(int slot) const
    {
        return _input == slot;
    }
     ...
     */
    Geom::Rect filter_primitive_area(Units const &units) const;
    ...
    /**
     * Sets the color space used for interpolating this filter primitive
     */
...
protected:
    ...
    std::shared_ptr<Colors::Space::AnySpace> _color_space; // interpolation
};

} // namespace Inkscape::Renderer::DrawingFilter

#endif // SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_PRIMITIVE_H
/*
  Local Variables:
  mode:c++
