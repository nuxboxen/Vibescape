...
#ifndef SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_OFFSET_H
#define SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_OFFSET_H

#include "primitive.h"

namespace Inkscape::Renderer::DrawingFilter {

class Offset : public Primitive
{
public:
    Offset() = default;
...
#endif // SEEN_INKSCAPE_RENDERER_DRAWING_FILTER_OFFSET_H
/*
  Local Variables:
  mode:c++
