...
void TextContext::set_paint_style(StyleMap const &map, SPStyle const *style, SPStyle const *context_style)
{
    ...
    if (!_soft_mask) {
        ...
        if (soft_mask || last_ca < 1.0 || last_CA < 1.0 || (double)style->fill_opacity < 1.0 || (double)style->stroke_opacity < 1.0) {
            ...
            if (soft_mask) {
                ...
                last_ca = (double)style->fill_opacity;
                last_CA = (double)style->stroke_opacity;
            }
